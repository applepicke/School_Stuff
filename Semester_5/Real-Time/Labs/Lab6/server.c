...
int main(int argc, char *argv[]) {
	...
	while (1) {
		...
		msg1.product = calculate_product(msg1.x, msg1.y);
		status1 = MsgReply(rcvid1, 0, &msg1.product, sizeof msg1.product);

		rcvid2 = MsgReceive(attach->chid, &msg2, sizeof msg2, NULL);
