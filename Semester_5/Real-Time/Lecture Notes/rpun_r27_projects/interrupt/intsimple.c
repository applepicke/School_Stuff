 ...
 * 
 *  On an x86 box some good choices for the interrupt to use would be:
 *    0 - timer - interrupts 1000 times/sec, don't print on every interrupt
 *    1 - keyboard 
 *
 *    intsimple
 *
...
int main (int argc, char **argv)
{
    ...
    while (1) {
        ...
        printf ("%s:  we got the event and unblocked, %d times\n", progname, ++count);
    }   
}
