...
/*
 * Purpose: Retrieve the value of a specified record in the symbol table
 * Author: William Collins (040652633)
 * History/Versions: 1.0
 * Parameters:	sym_table - The symbol table to be used
				vid_offset - The offset of the record to look at
 * Return value: An initialvalue of FAIL on fail, and the actual value otherwise
*/
InitialValue st_get_value (STD sym_table, int vid_offset){
	InitialValue value;
	value.int_val = FAIL;
