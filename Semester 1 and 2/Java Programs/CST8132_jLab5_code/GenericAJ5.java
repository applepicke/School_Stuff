...
//Replace existing activities
   ...
   System.out.print("\nThe first index of whatToDo[1] is - " + activity.indexOf(whatToDo[1]));
   
   activity.remove(0);
   System.out.print("\nAfter removing index 0, activity is empty - " + activity.isEmpty());
   
   activity.add(0, whatToDo[0]);
   activity.add(1, date[0]);
   activity.add(2, whatToDo[0]);
   activity.add(3, date[1]);
   
   Object whatIWillDo[] = activity.toArray();
   System.out.print("\n\nAfter sending activity to an array, new array [0] - " + whatIWillDo[0]);
