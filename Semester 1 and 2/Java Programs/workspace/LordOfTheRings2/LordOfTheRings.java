...
public class LordOfTheRings {
	...
	public static void main(String[] args) {
		...
		game.setSquare(0, 3, new Square('n', new Elf(7, 2)));
		game.setSquare(1, 0, new Square('n', new Wizard(5, 12)));
		game.setSquare(3, 2, new Square('n', new Hobbit(9, 5)));
		game.setSquare(3, 1, new Square('n', new Elf(5, 5)));
		game.setSquare(0, 2, new Square('n', new Orc(3, 14)));
