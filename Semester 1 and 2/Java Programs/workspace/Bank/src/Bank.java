	...
	public static void main (String args[]) {
		...
		while (interact !=0) {
			...
			if (interact == 1 || interact == 3) {	
				...
				do {
					if (interact == 3) {
						System.out.print("\nEnter the client number you wish to access: ");
